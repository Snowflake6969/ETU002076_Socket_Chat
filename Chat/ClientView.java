...
public class ClientView extends JFrame {
    ...
    private void initialize() { // initialize all the components of UI
        ...
        JButton clientSendMsgBtn = new JButton("Alefa");
        ...
        JLabel lblNewLabel = new JLabel("Ny en ligne");
        lblNewLabel.setHorizontalAlignment(SwingConstants.LEFT);
        lblNewLabel.setBounds(559, 43, 95, 16);
        frame.getContentPane().add(lblNewLabel);

        oneToNRadioBtn = new JRadioButton("1 hatramin'ny N");
        ...
        broadcastBtn = new JRadioButton("Ho an'ny rehetra");
